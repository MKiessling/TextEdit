...
public class ClosableTabbedPane extends JTabbedPane {
	...
	public void addTab(String title, Component component) {
		...
		saveList.add(super.getSelectedIndex(), 0);
	}
	...
	public void setSaved(int saved){
		saveList.set(super.getSelectedIndex(), saved);
	}
	...
	private class TabCloseUI implements MouseListener, MouseMotionListener {
		...
		public void closeTab(){
			...
			if (isToCloseTab && selectedTab > -1) {
				if (saveList.get(tabbedPane.getSelectedIndex()) != 1){
				...
				if (choice == JOptionPane.YES_OPTION ) {
					saveList.remove(tabbedPane.getSelectedIndex());
